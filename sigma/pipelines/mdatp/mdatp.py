...
def mdatp_example():      # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="kql example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"mdatp_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="mdatp_field_mapping",
